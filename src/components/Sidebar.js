        ...
        <div className="sidebar">
            <div className="sidebar-item">
                ...
                <div className="sidebar-menu-item">
                    <ul>
                        <li><a className="sidebar-menu-items" href="#">Label Text (4)</a></li>
                        <li><a className="sidebar-menu-items" href="#">Lacivert (3)</a></li>
                        <li><a className="sidebar-menu-items" href="#">Sarı (1)</a></li>
                        <li><a className="sidebar-menu-items" href="#">Siyah (5)</a></li>
                        <li><a className="sidebar-menu-items" href="#">Beyaz (2)</a></li>
                    </ul>
                </div>
            </div>
            <div className="sidebar-item">
